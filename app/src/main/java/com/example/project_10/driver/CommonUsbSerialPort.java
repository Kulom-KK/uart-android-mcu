...
package com.example.project_10.driver;
...
import com.example.project_10.util.MonotonicClock;
...
public abstract class CommonUsbSerialPort implements UsbSerialPort {
    ...
    @Override
    public int write(byte[] src, int timeout) throws IOException {write(src, src.length, timeout);
        return timeout;
    }
